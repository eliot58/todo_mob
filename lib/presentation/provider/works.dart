                                      ...
                                      child: ListTile(
                                        trailing: ElevatedButton(
                                            onPressed: () async {
                                              ...
                                              Dio().get('http://127.0.0.1:8000/api/v1/provider_check/${worksState.works[index]["id"]}/', options: Options(headers: {'Authorization': 'Token $token'}));
                                            },
                                                  ...
                                                  children: <Widget>[
                                                    ...
                                                    Expanded(
                                                      child: TextButton(
                                                          ...
                                                          onPressed: () async {
                                                            var url = Uri.parse('http://127.0.0.1:8000${worksState.works[index]["scetch_url"]}');
                                                            if (!await launchUrl(url)) {
                                                              throw 'Could not launch $url';
                                                            }
                                                          },
                                                          child: Text(Uri.decodeFull(worksState.works[index]["scetch"]), overflow: TextOverflow.ellipsis, style: const TextStyle(color: Colors.blue))),
                                                    ),
                                                  ],
                                                ),
                                              ),
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  Expanded(
                                                    child: TextButton(
                                                        ...
                                                        onPressed: () async {
                                                          var url = Uri.parse('http://127.0.0.1:8000${worksState.works[index]["file_url"]}');
                                                          if (!await launchUrl(url)) {
                                                            throw 'Could not launch $url';
                                                          }
                                                        },
                                                        child: Text(Uri.decodeFull(worksState.works[index]["file"]), overflow: TextOverflow.ellipsis, style: const TextStyle(color: Colors.blue))),
                                                  ),
                                                ],
                                              ),
                                            ),
                                          ...
                                          children: <Widget>[
                                            ...
                                            Padding(
                                              ...
                                              child: RichText(
                                                ...
                                                text: 'Стоимость: ',
                                                style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Color(0xff080696)),
                                                children: <TextSpan>[TextSpan(text: worksState.quantities[index]["order_price"].toString(), style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Colors.black))],
                                              )),
                                            ),
                                            Padding(
                                              padding: const EdgeInsets.only(bottom: 12),
                                              child: RichText(
                                                ...
                                                text: 'Профиль: ',
                                                style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Color(0xff080696)),
                                                children: <TextSpan>[TextSpan(text: worksState.quantities[index]["quantity_shape"], style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Colors.black))],
                                              )),
                                            ),
                                            Padding(
                                              padding: const EdgeInsets.only(bottom: 12),
                                              child: RichText(
                                                ...
                                                text: 'Фурнитура: ',
                                                style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Color(0xff080696)),
                                                children: <TextSpan>[TextSpan(text: worksState.quantities[index]["quantity_impl"], style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Colors.black))],
                                              )),
                                            ),
                                            Padding(
                                              padding: const EdgeInsets.only(bottom: 12),
                                              child: RichText(
                                                ...
                                                text: 'Желаемая цена: ',
                                                style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Color(0xff080696)),
                                                children: <TextSpan>[TextSpan(text: worksState.quantities[index]["quantity_price"].toString(), style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Colors.black))],
                                              )),
                                            ),
                                          ],
                                        ),
