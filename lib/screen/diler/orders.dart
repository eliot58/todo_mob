...
class _DilerOrdersState extends State<DilerOrders> {
  ...
  _setList() async {
    var response =  await Dio().get('http://127.0.0.1:8000/api/v1/orders/', options: Options(headers: {'Authorization': 'Token 62889d1f4515f03411220f9d27e01fb2db2eba9e'}));
    setState(() {
...
class _DilerOrderState extends State<DilerOrder> {
  ...
  _setdata() async {
    var response =  await Dio().get('http://127.0.0.1:8000/api/v1/order/${widget.id}/', options: Options(headers: {'Authorization': 'Token 62889d1f4515f03411220f9d27e01fb2db2eba9e'}));
    setState(() {
