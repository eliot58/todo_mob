                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.end, children: <Widget>[
                          ...
                          GestureDetector(
                            onTap: () async {
                              ...
                              Dio().get('http://127.0.0.1:8000/api/v2/logout/', options: Options(headers: {'Authorization': 'Token $token'}));
                            },
                                          ...
                                          children: <Widget>[
                                            ...
                                            Padding(
                                              ...
                                              child: RichText(
                                                ...
                                                text: 'Тип оплаты: ',
                                                style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Color(0xff080696)),
                                                children: <TextSpan>[TextSpan(text: ordersState.orders[index]["type_pay"], style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Colors.black))],
                                              )),
                                            ),
                                            Padding(
                                              padding: const EdgeInsets.only(bottom: 12),
                                              child: RichText(
                                                ...
                                                text: 'Тип доставки: ',
                                                style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Color(0xff080696)),
                                                children: <TextSpan>[TextSpan(text: ordersState.orders[index]["type_delivery"], style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Colors.black))],
                                              )),
                                            ),
                                            Padding(
                                              padding: const EdgeInsets.only(bottom: 12),
