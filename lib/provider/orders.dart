                ...
                itemBuilder: (BuildContext context, int index) {  
                  return Card(
                    ...
                    child: Padding(
                      ...
                      child: ListTile(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context)=> ProviderSend(id: _ordersList[index]["id"])));
                        },
                            ...
                            Padding(
                              ...
                              child: RichText(
                                text: TextSpan(
                                  ...
                                  children: <TextSpan>[
                                    TextSpan(text: _ordersList[index]["count_win"].toString(),style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Colors.black))
                                  ],
                                )
                              ),
                            ),
                            ...
                            Padding(
                              ...
                              child: RichText(
                                text: TextSpan(
                                  ...
                                  style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Color(0xff080696)),
                                  children: <TextSpan>[
                                    TextSpan(text: _ordersList[index]["type_pay"],style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Colors.black))
                                  ],
                                )
                              ),
                            ),
                            Padding(
                              ...
                              child: RichText(
                                text: TextSpan(
                                  ...
                                  style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Color(0xff080696)),
                                  children: <TextSpan>[
                                    TextSpan(text: _ordersList[index]["type_delivery"],style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Colors.black))
                                  ],
                                )
                              ),
                            ),
