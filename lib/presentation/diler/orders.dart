                                  ...
                                  subtitle: Column(
                                    ...
                                    children: <Widget>[
                                      Padding(
                                        ...
                                        child: Text(ordersState.orders[index]['date'], style: TextStyle(fontSize: 16.sp, fontWeight: FontWeight.w400)),
                                      ),
                                      Padding(
                                        padding: const EdgeInsets.only(bottom: 12),
                                        child: RichText(
                                          ...
                                          children: <TextSpan>[TextSpan(text: ordersState.orders[index]["user"], style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w400, color: Colors.black))],
                                        )),
                                      ),
                                      Padding(
                                        padding: const EdgeInsets.only(bottom: 12),
                                        child: RichText(
                                          ...
                                          text: 'Количество КП: ',
                                          style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w400, color: const Color(0xff15CE73)),
                                          children: <TextSpan>[TextSpan(text: ordersState.orders[index]['quantity_set'].length.toString(), style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w400, color: Colors.black))],
                                        )),
                                      ),
                                      Padding(
                                        padding: const EdgeInsets.only(bottom: 12),
