...
class CustomImagesFormField extends StatefulWidget {
  const CustomImagesFormField({
    Key? key,
    required this.validator,
    required this.onChanged,
  }) : super(key: key);
  ...
  @override
  State<CustomImagesFormField> createState() => _CustomImagesFormFieldState();
}

class _CustomImagesFormFieldState extends State<CustomImagesFormField> {
  List<PlatformFile>? _paths;
  String filename = '';
